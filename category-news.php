...
/**
 * The template for displaying News Articles.
 *
            ...
            <main class="site-main" id="main">
                ...
                <?php if (have_posts()) : ?>
                    ...
                    <header class="page-header">
                        <h1><?php _e('Insights: News', 'menziestheme'); ?></h1>
                        <?php
                ...
                <?php else : ?>
                    ...
                    <section class="no-results not-found">
                        ...
                        <header class="page-header">
                            ...
                            <h1 class="page-title"><?php esc_html_e('No News Articles Found', 'understrap'); ?></h1>
