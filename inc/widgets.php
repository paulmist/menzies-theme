	...
	function understrap_widgets_init() {
		...
		register_sidebar(
			array(
				...
				'id'            => 'footer_1',
				'description'   => __( 'First footer widget', 'understrap' ),
		...
		register_sidebar(
			array(
				...
				'id'            => 'footer_2',
				'description'   => __( 'Second footer widget', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="footer-widget">',
				'after_widget'  => '</div><!-- .footer-widget -->',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				...
				'id'            => 'footer_3',
				'description'   => __( 'Third footer widget', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="footer-widget">',
				'after_widget'  => '</div><!-- .footer-widget -->',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				...
				'id'            => 'blog',
				'description'   => __( 'Blog sidebar widget', 'understrap' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Careers Sidebar', 'understrap' ),
				'id'            => 'careers',
				'description'   => __( 'Careers sidebar widget', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="sidebar-widget">',
				'after_widget'  => '</div><!-- .footer-widget -->',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		// 		'id'            => 'search',
		// 		'description'   => __( 'header search widget', 'understrap' ),
		// 		'before_widget' => '<div id="%1$s" class="sidebar-widget">',
		// 		'after_widget'  => '</div><!-- .footer-widget -->',
		// 		'before_title'  => '<h3 class="widget-title">',
		// 		'after_title'   => '</h3>',
