...
/**
 * Template Name: Basic Inner Page
...
<?php while (have_posts()) : the_post(); ?>
    ...
    <main class="site-main" id="main">
        ...
        <article <?php post_class($has_hero); ?> id="post-<?php the_ID(); ?>">
            ...
            <div class="uk-container-centre p-t-medium p-b-large entry-content animatable fadeInDown animationDelaytwo">
                <?php the_content(); ?>
            </div>
        ...
        <a id="contact-us"></a>
            ...
            <div class="section-wrapper cta-banner-wrapper">

                <div class="cta-banner-container">
                    <div class="cta-banner-inner animatable fadeInUp animationDelayone">
                        <h3 class="modTitle"><span>Get in touch</span> with our trusted advisors</h3>
                        <p class="subPara">Start your journey towards Brighter Thinking</p>
                        <p><a class="readon yellow solid" href="/contact-us/">Enquire Today!</a></p>
