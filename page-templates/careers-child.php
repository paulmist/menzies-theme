<?php
/**
 * Template Name: Careers child page
 *
				...
				<div class="row">
					...
					<div class="col-lg-4">
						...
						<aside class="blog-sidebar sidebar">
							...
							<div class="careers-widget sidebar-widget">

								<a href="/careers/#job-listings">

									<i class="fa fa-briefcase" aria-hidden="true"></i><h3 class="inline-heading"><?php _e( 'View current vacancies', 'menziestheme'); ?></h3>
