...
/**
 * Template Name: Inner page upgrade
...
<?php while (have_posts()) : the_post(); ?>
	<?php $author_object = get_field('author');
	?>
	...
	<main class="site-main" id="main">
		...
		<article class="entry-content" <?php post_class($has_hero); ?> id="post-<?php the_ID(); ?>">

			<div class="slim-content-container">
				<?php the_content(); ?>
			</div>
