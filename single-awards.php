...
/**
 * The template for displaying single awards.
 *
 * @package understrap
 */
...
<?php while (have_posts()) : the_post(); ?>
	...
	<main class="site-main" id="main">
		...
		<div class="pageHeader animatable fadeInDown animationDelayone">
			<div class="pageHeaderInner <?php if ($inner_page_header['centred_text']) : echo 'pageHeaderCenter';
										endif; ?> animatable fadeInDown animationDelayone">


				<div class="post-categories">
					<span class="post-category-tag">Awards</span>
				</div>
		...
		<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
			<div class="itemView itemSuccessStory ItemBlog">
				<a id="page"></a>
				<div class="itemSuccessPage">
					<div class="itemSuccessBody spotlightBody entry-content">
						<?php the_content(); ?>
					</div>
					<div class="itemSuccessSide">
						<div class="spotlight-sidebar-inner">
							...
							<div class="award-meta">
								<div class="award-meta-item award-meta-item-year">
									<h3><?php _e('Year', 'menziestheme'); ?></h3>
									<h5><?php the_field('year'); ?></h5>
								</div>
								<div class="award-meta-item award-meta-item-body">
									<h3><?php _e('Awarding body', 'menziestheme'); ?></h3>
									<h5><?php the_field('awarding_body'); ?></h5>
									<p><a href="https://menziesllpdev.wpenginepowered.com/menzies-awards/" class="readon">Back to awards</a></p>
								</div>
							</div>
						</div>
					</div>
