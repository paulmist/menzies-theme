					...
					<div class="col-lg-8">
						...
						<?php if(!$featured_img_url): ?>
							...
							<header class="entry-header">
								...
								<div class="single-post-cat"><?php echo sprintf( '<a href="%s">%s</a>', get_category_link( $first_category ), $first_category->name ); ?> - <?php _e( 'Published ', 'menziestheme'); ?><?php the_date('jS F Y'); ?></div>
